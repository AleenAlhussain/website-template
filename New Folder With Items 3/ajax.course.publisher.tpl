  ...
  <div class="modal-body">
	{if $system['paid_courses_enabled']}
      <div class="alert alert-warning">
        ...
        <div class="text">
          {__("This course post will cost you")} <span class="badge rounded-pill bg-warning">{$system['paid_courses_cost']} {$system['system_currency']}</span> {__("to publish. The cost will be deducted from your wallet balance")}
        </div>
      </div>
    {/if}
    ...
    <div class="form-group">
      ...
      <div>
        <div class="input-group">
          ...
          <select class="form-control" name="fees_currency">
