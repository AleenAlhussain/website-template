		...
		<div class="valign">
			...
			<div class="post-meta">
				...
				<div class="valign post-time">
					...
					{if $post['location']}
						<span class="font-weight-bold ml5 mr5">·</span><span class="post-sub-item">{$post['location']}</span>
					{/if}
    ...
    {if $user->_logged_in}
        <div class="valign post-actions">
            ...
            {if $post['privacy'] == "public"}
				<div class="valign action-btn" data-toggle="modal" data-url="posts/share.php?do=create&post_id={$post['post_id']}&photo_id={$photo['photo_id']}" title='{__("Share")}'>
    ...
    <div class="valign post-stats">
		...
		<div class="valign">
			{if $photo['reactions_total_count'] > 0}
				<div data-toggle="modal" data-url="posts/who_reacts.php?{if $photo['is_single']}post_id={$post['post_id']}{else}photo_id={$photo['photo_id']}{/if}">
		...
		<div class="valign">
			<!-- comments -->
			{if $photo['comments'] > 0}
			<span class="pointer js_comments-toggle">{$photo['comments_formatted']} {__("Comments")}</span>
			{/if}
			<!-- comments -->
