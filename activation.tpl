...
<div class="container position-relative">
	<div class="ele_content text-center p-5">
		...
		<div>
            {if $system['activation_type'] == "email"}
				<button type="button" class="btn btn-success btn-mat mr10" data-toggle="modal" data-url="#activation-email">{__("Enter Code")}</button>
				<button type="button" class="btn btn-primary btn-mat mr10" data-toggle="modal" data-url="core/activation_email_resend.php">{__("Resend Email")}</button>
